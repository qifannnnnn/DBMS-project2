    ...
    public FakebookArrayList<UsersPair> suggestFriends(int num) throws SQLException {
        ...
        try (Statement stmt = oracle.createStatement(FakebookOracleConstants.AllScroll, FakebookOracleConstants.ReadOnly)) {
            ...
            ResultSet rst1=stmt2.executeQuery("SELECT MUTUAL.COUNT, U1.USER_ID AS USER1, U1.FIRST_NAME AS FIRST1, U1.LAST_NAME AS LAST1, U2.USER_ID AS USER2, " +
                    " U2.FIRST_NAME AS FIRST2, U2.LAST_NAME AS LAST2, U3.USER_ID AS FID, U3.FIRST_NAME AS FFIRST, U3.LAST_NAME AS FLAST  " +
                    " FROM "+
                    " (SELECT * FROM "+
            ...
            Long id1=null;
            Long id2=null;
            UsersPair up=new UsersPair(new UserInfo(1,null,null), new UserInfo(1,null,null) );
            while (rst1.next() ){
                if (rst1.isFirst()){
                    id1=rst1.getLong(2);
                    id2= rst1.getLong(5);
                ...
                else if (!(rst1.getLong(2)==id1) || !(rst1.getLong(5)==id2))
                {
                    results.add(up);
                    id1 = rst1.getLong(2);
                    id2 = rst1.getLong(5);
